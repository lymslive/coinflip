...
function LevelsListCell:ctor(size, beginLevelIndex, endLevelIndex, rows, cols)
    ...
    for row = 1, rows do
	    ...
	    --local icon = display.newSprite("#UnlockedLevelIcon.png", x, y)
	    -- 根据当前进度显示不同的关卡背景
	    local png = "#<iconname>.png"
    ...
    -- TODO: what is this ? 好像没法解法点击高亮效果
    self.highlightButton = display.newSprite("#HighlightLevelIcon.png")
    -- self.highlightButton = display.newSprite("#UnlockedLevelIcon.png")
